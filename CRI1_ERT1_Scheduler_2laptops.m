...
function [num_chargers, Testing_Schedule, Testing_Summary] = CRI1_ERT1_Scheduler_2laptops(number_of_days, number_of_chargers) 
    ...
    for num_day = 1:TotalTest_Days
        while time < 60*8
            if Charging == 0
                ...
                %Objective function
                prob = optimproblem('Objective', charge_time + x6+d6 - 40 + 10, 'ObjectiveSense','max');
                ...
                prob.Constraints.c8 = charging_time + x6+d6 - 40 + 10 <= 60*8 - time;
                ...
                number_of_tests = (sol.x6 + sol.d6)/(40+10+20+10+8+15);
            ...
            %-------------------------------------------------------------------------------------------------
                ...
                %Objective funtion
                prob = optimproblem('Objective', x6+d6, 'ObjectiveSense','max');
                ...
                prob.Constraints.c8 = x6+d6<= 60*8-time;
